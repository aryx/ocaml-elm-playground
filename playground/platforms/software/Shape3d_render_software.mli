 ...
 * tracer's triangles, each point with its normal, its texture
 * coordinates and its face's material; a texture sampled at the hit by
 * the rasterizer's own Texture.sample_bilinear ([bilinear], default)
 * or sample_nearest *)
val solids : ?bilinear:bool -> Playground3d.shape3d -> Solid.t list
