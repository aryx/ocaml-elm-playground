...
// games/js/) in node, without a browser, with a tiny fake DOM, to debug
// hangs and exceptions that are hard to observe in Chrome (a tab stuck in
// an infinite loop can't even show its console).
//
// usage:
//   node docs/claude_notes/web_headless.js _build/default/games/js/Tetris.bc.js [frames] [keys]
// e.g.
//   timeout 10 node docs/claude_notes/web_headless.js \
//     _build/default/games/js/Tetris.bc.js 300 ArrowLeft,ArrowUp,' '
//
