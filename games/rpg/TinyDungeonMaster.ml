 ...
 *
 * This is the oldest of the 2.5D games' tricks, and the only one with
 ...
 *
 * Which is why this is the longest of the 2.5D games although its
 * renderer is the shortest of theirs, and that is the whole point: the
 * other 2.5D games are locomotion, and nearly all of their
 ...
 * exactly the same place. Not a 3D twin, though, the way
 ...
 * in 24 lines, the shortest of the 2.5D games (the two faces it feeds,
