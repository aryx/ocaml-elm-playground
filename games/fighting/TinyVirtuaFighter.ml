 ...
 *
 * So this game is TinyStreetFighter with its figure replaced:
 *
 *     TinyStreetFighter      TinyVirtuaFighter
 ...
 * TinyStreetFighter and TinyFinalFight) and its 3D half's
 ...
 * hit; a shadow under each fighter (TinyMario64's) so the ring
...
(*****************************************************************************)
(* Moves: the same frames as TinyStreetFighter's *)
(*****************************************************************************)
 ...
 * it is reading the fight. Three rules, like TinyBoomerangFu's. *)
