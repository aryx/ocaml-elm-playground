 ...
 * gamekits/isometric's, shared with TinyDiablo: the same three
 ...
 * this world inside the rule the rest of the 2.5D games live by, one
 ...
 *
 * Depth is settled the way every 2.5D game settles it, by the order of
 ...
 *
 * The fourth family of the 2.5D games, then, next to cell by cell
 ...
 * and the line of sight, shared with TinyDiablo) and
 ...
 * also what keeps this world inside the rule the rest of the 2.5D
 * games live by: one height per point of the map, and the drawing order
 * settles everything. *)
 ...
 * arithmetic is gamekits/isometric's, shared with TinyDiablo;
