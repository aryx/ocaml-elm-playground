 ...
 * all (TinyRick.ml, whose header points here), and this is that
 ...
 * live in one *page* (games/adventure/tomb.png, a 2 x 2 grid of 64 x 64 tiles)
 ...
 * TinyMinecraft.ml carries its own), Camera3d (behind: the
 * chase camera), and gamekits/puzzle's Push -- the
 * same Push that TinySokoban.ml uses, on the tomb's floor grid,
 ...
 * (the game's dune file turns tomb.png into Tomb_atlas.base64 at build time),
