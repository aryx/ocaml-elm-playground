 ...
 * Robotron: 2084 (games/TinyRobotron.ml).
 *
 ...
 *    again. Asteroids' wrap (games/Asteroid.ml) is the same idea on a
 ...
 *    games/TinyWorms.ml) would be 6000 numbers and a seam to get
 *    right.
 *
