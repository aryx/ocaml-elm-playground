 ...
 * drew it column by column, like Wolfenstein 3D (TinyWolfenstein.ml), but
 ...
 * spans, sampled like TinyMarioKart's Mode 7); here, flat colors, the
 ...
 * TinyDoom3d: the same level with polygons and a z-buffer, no
