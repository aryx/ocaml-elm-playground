 ...
 *)
(* TinyWolfenstein.ml again, in real 3D: the same map, the same controls,
...
(*****************************************************************************)
(* The map, and walking: as in TinyWolfenstein.ml *)
(*****************************************************************************)

(* coupling: the same map as TinyWolfenstein.ml's *)
let map =
