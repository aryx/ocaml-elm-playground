 ...
 *)
(* TinyPinball.ml's table again, in 3D and on the physics engine:
...
(*****************************************************************************)
(* The table: TinyPinball.ml's, in millimetres *)
(*****************************************************************************)

(* coupling: from here to [ready], TinyPinball.ml's table and
