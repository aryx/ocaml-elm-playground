...
| `apps/music/Voice_juno` | the Juno-106: the DCO (in tune by a clock), one envelope for both filter and amplifier (Harman's measured curves), one high-pass after the six voices, the BBD chorus I, II and I+II (its measured rates and delays, the right line inverted) | §10 | done |
