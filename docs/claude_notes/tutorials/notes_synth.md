...
| `apps/music/Studio_opxy`, `TinyOpxy` | the OP-XY: eight tracks on one clock, steps of chords with parameter locks, an OP-1 sound, a kit sampled from our 808 or a sampled Rhodes per track, scenes switched at the bar, the brain transposing by scale degree | §10 | done |
