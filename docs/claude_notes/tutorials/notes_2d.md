...
| `r` | resolution: full, a half, a third, a quarter, each pixel shown as a 2x2 to 4x4 block, without antialiasing (`graphics/core/Pixelate.mli`) | `games2.5d/software/TinyWolf.exe`: 10 times faster at a third |
