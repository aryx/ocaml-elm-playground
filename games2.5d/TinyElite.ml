 ...
 *
 * The directory: games2.5d/README.md calls these worlds "a flat map
 * with one height per point", and Elite's is not. It is here for the
 * reason games2.5d/TinyDescent is: it is full 3D with no 3D engine but
