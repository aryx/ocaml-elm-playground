 ...
 *
 * The rules are Pong's (games/TinyPong.ml), and the physics the
 ...
 * games2.5d/: everything is on one plane, the table, seen from one eye
 ...
 *
 * It is games2.5d/TinyMarioKart's Mode 7 for a table that never turns: the
 ...
 * it.
 *
 * The table is playground/Physics's, in metres, as games/TinyPinball.ml's
