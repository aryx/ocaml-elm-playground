 ...
 *   q            drink a potion
 *
 * Diablo is Rogue with the turns taken out. games/TinyRogue.ml is the
 ...
 *    trick as games/TinyFlappyBird.ml's pipes, in two dimensions.
 *
...
(* A linear-feedback shift register, as in games/TinyFlappyBird.ml: the
 ...
 * is tidier, see games/TinyRogue.ml) *)
