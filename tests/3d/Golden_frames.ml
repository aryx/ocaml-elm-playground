...
let scripted : Testutil_golden.scripted list =
  [ ("games3d/software/StarCollector3d", "move", 40, "up:1-40,right:10-25");
    ...
    ("games3d/software/TinyBoomerangFu3d", "flight", 45, "space:1,right:5-25,space:26,right:30-60");
    ...
    ("games3d/software/TinyBoomerangFu3d", "cut", 95, "space:1,up:5-40,right:41-70,space:71,right:75-140") ]
