(* Sectors: a level the way Doom (id Software, 1993) describes one, a
   ...
   What the games do with a level is theirs: games/TinyDoom draws it the
   ...
   A kit (kits/sectors/), a layer on top of nothing, only numbers, like
...
(* the level of games/TinyDoom and games3d/TinyDoom3d: a hall with a
 ...
 * (the simple way; Doom walked its BSP tree, see games/TinyDoom); 0 if
 * none *)
