 ...
 *)
(* games2.5d/TinyElite.ml again, with solid ships drawn by playground3d:
...
(*****************************************************************************)
(* The flight: games2.5d/TinyElite.ml's rules *)
(*****************************************************************************)
 ...
 * copy of games2.5d/TinyElite.ml's, so that the same keys fly the same
...
(* the system, which games2.5d/TinyElite works out from the galaxy's seed *)
