 ...
 *
 * Uses: Track3d (the canyon, with games3d/TinyMarioKart64 and
 * games3d/TinyVirtuaRacing), the shmup kit's Path and Shots (with
 * games/TinyGalaga and games/TinyGradius), Scene2d, Camera3d. Not
