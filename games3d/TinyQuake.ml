 ...
 *
 * Doom's renderer is the lesson of games2.5d/TinyDoom, and Descent's
 * portals that of games2.5d/TinyDescent. Quake's lesson is neither:
 ...
 * SelectPartition weighs, and games2.5d/TinyDoom's node builder before
 * it. *)
