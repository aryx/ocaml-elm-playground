 ...
 * TowerFall (both 2013) to this one. games/TinyBomberman.ml is this
 ...
 * ground drags a [shadow] under it, exactly as games3d/TinyMario64.ml's
 ...
 * for its 9 frames, like every move in games3d/TinyTombRaider.ml), and
