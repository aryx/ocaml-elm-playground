...
Lisp over `libs/languages/lisp`, Turbo Pascal's IDE over
`libs/languages/pascal`, and Smalltalk-80's environment over
`libs/languages/smalltalk` (`plan_tiny_smalltalk.md`).
